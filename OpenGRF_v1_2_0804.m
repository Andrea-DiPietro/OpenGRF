...
x_angle=str2double('0');

z_angle=str2double('0')-pi/2;
...
if FullBody
X_Hand_l=BodyPos(:,strcmp(Head_BK,strcat(hand_l_name,"_X")));
Y_Hand_l=BodyPos(:,strcmp(Head_BK,strcat(hand_l_name,"_Y")));
Z_Hand_l=BodyPos(:,strcmp(Head_BK,strcat(hand_l_name,"_Z")));
X_Hand_r=BodyPos(:,strcmp(Head_BK,strcat(hand_r_name,"_X")));
Y_Hand_r=BodyPos(:,strcmp(Head_BK,strcat(hand_r_name,"_Y")));
Z_Hand_r=BodyPos(:,strcmp(Head_BK,strcat(hand_r_name,"_Z")));
end
%% toes p,v,a
X_Toes_l=BodyPos(:,strcmp(Head_BK,strcat(toes_l_name,"_X")));
Y_Toes_l=BodyPos(:,strcmp(Head_BK,strcat(toes_l_name,"_Y")));
Z_Toes_l=BodyPos(:,strcmp(Head_BK,strcat(toes_l_name,"_Z")));
X_Toes_r=BodyPos(:,strcmp(Head_BK,strcat(toes_r_name,"_X")));
Y_Toes_r=BodyPos(:,strcmp(Head_BK,strcat(toes_r_name,"_Y")));
Z_Toes_r=BodyPos(:,strcmp(Head_BK,strcat(toes_r_name,"_Z")));

v_toes_l_x=BodyVel(:,strcmp(Head_BK,strcat(toes_l_name,"_X")));
v_toes_l_y=BodyVel(:,strcmp(Head_BK,strcat(toes_l_name,"_Y")));
v_toes_l_z=BodyVel(:,strcmp(Head_BK,strcat(toes_l_name,"_Z")));
v_toes_l=sqrt(v_toes_l_x.^2+v_toes_l_y.^2+v_toes_l_z.^2);

a_toes_l_x=BodyAcc(:,strcmp(Head_BK,strcat(toes_l_name,"_X")));
a_toes_l_y=BodyAcc(:,strcmp(Head_BK,strcat(toes_l_name,"_Y")));
a_toes_l_z=BodyAcc(:,strcmp(Head_BK,strcat(toes_l_name,"_Z")));
a_toes_l=sqrt(a_toes_l_x.^2+a_toes_l_y.^2+a_toes_l_z.^2);

v_toes_r_x=BodyVel(:,strcmp(Head_BK,strcat(toes_r_name,"_X")));
v_toes_r_y=BodyVel(:,strcmp(Head_BK,strcat(toes_r_name,"_Y")));
v_toes_r_z=BodyVel(:,strcmp(Head_BK,strcat(toes_r_name,"_Z")));
v_toes_r=sqrt(v_toes_r_x.^2+v_toes_r_y.^2+v_toes_r_z.^2);

a_toes_r_x=BodyAcc(:,strcmp(Head_BK,strcat(toes_r_name,"_X")));
a_toes_r_y=BodyAcc(:,strcmp(Head_BK,strcat(toes_r_name,"_Y")));
a_toes_r_z=BodyAcc(:,strcmp(Head_BK,strcat(toes_r_name,"_Z")));
...
%% calcn p,v,a
X_Calcn_l=BodyPos(:,strcmp(Head_BK,strcat(calcn_l_name,"_X")));
Y_Calcn_l=BodyPos(:,strcmp(Head_BK,strcat(calcn_l_name,"_Y")));
Z_Calcn_l=BodyPos(:,strcmp(Head_BK,strcat(calcn_l_name,"_Z")));
X_Calcn_r=BodyPos(:,strcmp(Head_BK,strcat(calcn_r_name,"_X")));
Y_Calcn_r=BodyPos(:,strcmp(Head_BK,strcat(calcn_r_name,"_Y")));
Z_Calcn_r=BodyPos(:,strcmp(Head_BK,strcat(calcn_r_name,"_Z")));

v_calcn_l_x=BodyVel(:,strcmp(Head_BK,strcat(calcn_l_name,"_X")));
v_calcn_l_y=BodyVel(:,strcmp(Head_BK,strcat(calcn_l_name,"_Y")));
v_calcn_l_z=BodyVel(:,strcmp(Head_BK,strcat(calcn_l_name,"_Z")));
v_calcn_l=sqrt(v_calcn_l_x.^2+v_calcn_l_y.^2+v_calcn_l_z.^2);

a_calcn_l_x=BodyAcc(:,strcmp(Head_BK,strcat(calcn_l_name,"_X")));
a_calcn_l_y=BodyAcc(:,strcmp(Head_BK,strcat(calcn_l_name,"_Y")));
a_calcn_l_z=BodyAcc(:,strcmp(Head_BK,strcat(calcn_l_name,"_Z")));
a_calcn_l=sqrt(a_calcn_l_x.^2+a_calcn_l_y.^2+a_calcn_l_z.^2);

v_calcn_r_x=BodyVel(:,strcmp(Head_BK,strcat(calcn_r_name,"_X")));
v_calcn_r_y=BodyVel(:,strcmp(Head_BK,strcat(calcn_r_name,"_Y")));
v_calcn_r_z=BodyVel(:,strcmp(Head_BK,strcat(calcn_r_name,"_Z")));
v_calcn_r=sqrt(v_calcn_r_x.^2+v_calcn_r_y.^2+v_calcn_r_z.^2);

a_calcn_r_x=BodyAcc(:,strcmp(Head_BK,strcat(calcn_r_name,"_X")));
a_calcn_r_y=BodyAcc(:,strcmp(Head_BK,strcat(calcn_r_name,"_Y")));
a_calcn_r_z=BodyAcc(:,strcmp(Head_BK,strcat(calcn_r_name,"_Z")));
...
CMCtool.setResultsDir(path_iter);
...
CMCtool.setLowpassCutoffFrequency(Freq_cutoff(t));
...
[PredGRF_iter,HeadSTO]=load_sto(fullfile(path_iter,'_Actuation_force.sto'));
PredGRF=[PredGRF;mean(PredGRF_iter,[1,length(PredGRF_iter)])];
KinOut_iter=load_mot(fullfile(path_iter,'_Kinematics_q.sto'));
KinOut=[KinOut;mean(KinOut_iter,[1,length(KinOut_iter)])];
pErr_iter=load_sto(fullfile(path_iter,'_pErr.sto'));
